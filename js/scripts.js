...
function PageLoad() {
	...
	setTimeout(function () {
		...
		TweenMax.to($('.hold-progress-bar'), 0.3, {
			force3D: true, width: '100%', delay: 0, ease: Power2.easeOut, onComplete: function () {  //modified time 2019 nov
...
function PageLoadActions() {
	...
	$('.next-ajax-link-project').on('click', function () {
		...
		TweenMax.to($(".next-project-image"), 0.6, {
			scale: 1, opacity: 1, ease: Power2.easeOut, onComplete: function () {
	...
	if ($('#showcase-slider-holder').length > 0) {
		...
		if (!$("body").hasClass("load-no-ajax")) {
			$('#showcase-slider-holder .slide-title').on('click', function () {
				...
				TweenMax.to('#showcase-slider .inner .subtitle', 0.3, {
					opacity: 1, delay: 0.4, ease: Power2.easeOut, onComplete: function () {
						parent_slide.find('.slide-title').appendTo('.temporary-hero .inner')
						parent_slide.find('.subtitle').appendTo('.temporary-hero .inner')
